...
@dso_cache = dso_local local_unnamed_addr global [532 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 127863914, ; hash 0x79f0c6a, from name: UraniumUI.Material
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.27_name, ; name: libaot-UraniumUI.Material.dll.so
		ptr null; void* handle (0x0)
	}, ; 8
	%struct.DSOCacheEntry {
		i64 131874241, ; hash 0x7dc3dc1, from name: aot-UraniumUI.Icons.MaterialIcons.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 138338362, ; hash 0x83ee03a, from name: aot-UraniumUI.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 288749039, ; hash 0x1135f5ef, from name: UraniumUI.Material.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.27_name, ; name: libaot-UraniumUI.Material.dll.so
		ptr null; void* handle (0x0)
	}, ; 34
	...
	%struct.DSOCacheEntry {
		i64 533293088, ; hash 0x1fc96820, from name: libaot-Plainer.Maui
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 609676966, ; hash 0x2456eea6, from name: UraniumUI.Icons.MaterialIcons.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.26_name, ; name: libaot-UraniumUI.Icons.MaterialIcons.dll.so
		ptr null; void* handle (0x0)
	}, ; 68
	...
	%struct.DSOCacheEntry {
		i64 674913690, ; hash 0x283a5d9a, from name: aot-UraniumUI.Material
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.27_name, ; name: libaot-UraniumUI.Material.dll.so
		ptr null; void* handle (0x0)
	}, ; 76
	...
	%struct.DSOCacheEntry {
		i64 1818317796, ; hash 0x6c6153e4, from name: libaot-CrudMaui
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2372998598, ; hash 0x8d7115c6, from name: aot-CrudMaui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CrudMaui.dll.so
		ptr null; void* handle (0x0)
	}, ; 284
	...
	%struct.DSOCacheEntry {
		i64 2705949843, ; hash 0xa1498493, from name: aot-CrudMaui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CrudMaui.dll.so
		ptr null; void* handle (0x0)
	}, ; 331
	...
	%struct.DSOCacheEntry {
		i64 3314691122, ; hash 0xc5922c32, from name: CrudMaui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CrudMaui.dll.so
		ptr null; void* handle (0x0)
	}, ; 414
	...
	%struct.DSOCacheEntry {
		i64 4059782148, ; hash 0xf1fb5c04, from name: CrudMaui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CrudMaui.dll.so
		ptr null; void* handle (0x0)
	}, ; 504
	...
	%struct.DSOCacheEntry {
		i64 4148476809, ; hash 0xf744bb89, from name: libaot-CrudMaui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CrudMaui.dll.so
		ptr null; void* handle (0x0)
	}, ; 518
